...
public class GroupedTableController implements Serializable {
	...
	private void populateRandomSales() {
		for(int i = 0 ; i < 10 ; i++) {
			mobileList.add(new Mobile("Model"+i, getQ1Sales(), getQ1Profits(),getQ2Sales(), getQ2Profits(),getQ3Sales(), getQ3Profits(),getQ4Sales(), getQ4Profits()));
		}
	}
    ...
    public long getQ4TotProfit()
    {
     ...
     public class Mobile implements Serializable
     {
       ...
       public long q4Profit;
         ...
         public Mobile(String manufacturer, long q1Sale, long q2Sale, long q3Sale, long q4Sale, long q1Profit, long q2Profit, long q3Profit, long q4Profit) {
